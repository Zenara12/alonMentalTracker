...
const bibleVerses = ref([
  ...
  { text: 'The Lord is my shepherd; I shall not want.', toggle: false, reference: 'Psalm 23:1' },
  {
  ...
  { text: 'For we walk by faith, not by sight.', toggle: true, reference: '2 Corinthians 5:7' },
  {
